...
Vue.component("simple_hero_component_1722425136", {
    template: `
        <section id="hero-section" style="min-height: 590px"  class="bg-gradient-to-r from-pink-500 to-purple-600 dark:from-pink-700 dark:to-purple-800 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div id="hero-title-container-text" class="flex">
                        <h1 id="hero-title" class="flex-1 max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-pink-100">Unleash Your Fitness Potential</h1>
                    </div>
                    ...
                    <div id="hero-buttons-container" class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <div id="hero-button-1-container" class="flex">
                            <a id="hero-button-1" href="https://github.com/themesberg/landwind" class="flex-1 items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-purple-900 bg-pink-300 border border-pink-400 rounded-lg sm:w-auto hover:bg-pink-400 focus:ring-4 focus:ring-pink-200">Get Started</a>
                        </div>

                        <div id="hero-button-2-container" class="flex">
                            <a id="hero-button-2" href="https://www.figma.com/community/file/1125744163617429490" class="flex-1 items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-pink-200 bg-purple-700 border border-purple-600 rounded-lg sm:w-auto focus:outline-none hover:bg-purple-800 hover:text-white focus:z-10 focus:ring-4 focus:ring-purple-500">Learn More</a>
                        </div>
                    </div>
