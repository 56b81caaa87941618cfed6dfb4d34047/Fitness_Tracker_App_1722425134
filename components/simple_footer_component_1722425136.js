...
*/
Vue.component("simple_footer_component_1722425136", {
    template: `
    <footer id="footer-section" style="min-height: 270px" class="flex-1 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-pink-200">
                        Stay motivated, crush your goals! FitHub is here to help you train smarter and achieve your fitness dreams.
                    </div>
                </div>
            </div>
        </footer> 
